        ...
        <div className="space-y-4 relative">
          ...
          <div className="absolute top-8 pointer-events-none" style={{ left: 'calc(5rem + 1rem)', right: '0', height: '100%' }}>
            ...
            >
              ...
              />
              {/* Data point circles */}
              <circle cx="0" cy="75" r="2" fill="#0ea5e9" className="animate-scale-in" />
              <circle cx="33" cy="65" r="2" fill="#0ea5e9" className="animate-scale-in" />
              <circle cx="66" cy="45" r="2" fill="#0ea5e9" className="animate-scale-in" />
              <circle cx="100" cy="25" r="2" fill="#0ea5e9" className="animate-scale-in" />
            </svg>
          </div>
        </div>
